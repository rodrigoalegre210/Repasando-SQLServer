...
-- 4
ALTER TABLE visitantes
ADD CONSTRAINT DF_visitantes_mc
DEFAULT 0
FOR montocompra;
...
-- 9
ALTER TABLE visitantes
ADD CONSTRAINT DF_visitantes_num
DEFAULT 39
FOR numero;
...
-- 6
ALTER TABLE vehiculos
ADD CONSTRAINT DF_vehiculo_tipo2
DEFAULT 'm'
FOR tipo;

-- 7
ALTER TABLE vehiculos
ADD CONSTRAINT DF_vehiculo_HL
DEFAULT GETDATE()
FOR horallegada;

-- 8
insert into vehiculos values('BDG134',default,default,null);
