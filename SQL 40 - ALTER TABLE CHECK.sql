...
-- 7
ALTER TABLE empleados
ADD CONSTRAINT CK_fechanacimiento_acutal
CHECK (fechanacimiento < GETDATE())
...
-- 9
ALTER TABLE empleados
ADD CONSTRAINT CK_empleados_rango_hijos
...
-- 12
insert into empleados values ('34444444','Carlos Caseres','2030/10/05',0,'Contaduría',5000);
...
-- 14
UPDATE empleados SET seccion = 'Ciencia'
WHERE documento = '33333333';
...
-- 6
ALTER TABLE vehiculos
ADD CONSTRAINT CK_vehiculo_tipo_valores
CHECK (tipo IN ('auto', 'moto'))
...
-- 12
insert into vehiculos values('ABC123','auto','2026/05/05 10:10',null);
...
-- 15
ALTER TABLE vehiculos
ADD CONSTRAINT DF_vehiculos_fechahoraentradaactual
DEFAULT GETDATE()
FOR fechahoraentrada;
